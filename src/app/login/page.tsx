        ...
        <form action={loginAction as unknown as (formData: FormData) => void} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm text-black placeholder:text-slate-400 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
          </div>
          <div>
